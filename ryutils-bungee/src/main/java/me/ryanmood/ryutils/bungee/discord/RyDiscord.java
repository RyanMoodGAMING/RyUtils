package me.ryanmood.ryutils.bungee.discord;

import lombok.AccessLevel;
import lombok.Getter;
import me.ryanmood.ryutils.base.discord.RyDiscordBase;
import me.ryanmood.ryutils.bungee.RyMessageUtil;
...
@Getter
public abstract class RyDiscord implements RyDiscordBase<ProxiedPlayer> {
     ...
     */
    @Override
    public void sendPlayerEmbed(TextChannel channel, ProxiedPlayer player, String content, boolean contentInAuthor, Color colour) {
        if (channel == null) {
            RyMessageUtil.getUtil().sendError("An error occurred while trying to send a message to a channel.");
            return;
        }
