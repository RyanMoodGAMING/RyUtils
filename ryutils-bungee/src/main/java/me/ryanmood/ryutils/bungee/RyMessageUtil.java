...
@Getter
@Setter
public class RyMessageUtil implements RyMessagesBase<ProxiedPlayer, CommandSender> {
     ...
     * @return A formatted string.
     */
    public Component adventureTranslate(ProxiedPlayer player, String message) {
        message.replace("%player%", player.getName());
     ...
     */
    public void sendPlayer(ProxiedPlayer player, String message) {
        if (this.audiences == null) player.sendMessage(TextComponent.fromLegacy(this.translate(player, message)));
     ...
     */
    public void sendPlayer(ProxiedPlayer player, String... messages) {
     ...
     * @param messages The messages you wish to send the player.
     */
    public void sendPlayer(ProxiedPlayer player, List<String> messages) {
    ...
    public void sendSender(CommandSender sender, String message) {
        if (this.audiences == null) sender.sendMessage(TextComponent.fromLegacy(this.translate(message)));
    ...
    public void sendConsole(boolean prefix, String message) {
        ...
        if (this.audiences == null) ProxyServer.getInstance().getConsole().sendMessage(TextComponent.fromLegacy(this.translate(message)));
    ...
    public void broadcast(String message) {
        if (this.audiences == null) ProxyServer.getInstance().broadcast(TextComponent.fromLegacy(this.translate(message)));
    ...
    public void broadcast(String permission, String message) {
        for (ProxiedPlayer online : ProxyServer.getInstance().getPlayers()) {
            if (online.hasPermission(permission)) {
                if (this.audiences == null) online.sendMessage(TextComponent.fromLegacy(this.translate(message)));
     ...
     */
    public void broadcast(ProxiedPlayer player, String message) {
        if (this.audiences == null) ProxyServer.getInstance().broadcast(TextComponent.fromLegacy(this.translate(player, message)));
     ...
     * @param message    The message to be broadcasted.
     */
    public void broadcast(ProxiedPlayer player, String permission, String message) {
        for (ProxiedPlayer online : ProxyServer.getInstance().getPlayers()) {
            if (online.hasPermission(permission)) {
                if (this.audiences == null) online.sendMessage(TextComponent.fromLegacy(this.translate(player, message)));
    ...
    public void sendError(String error, boolean disable) {
        ...
        if (disable && this.getPlugin() != null) {
            ProxyServer.getInstance().getPluginManager().unregisterCommands(this.getPlugin());
            ProxyServer.getInstance().getPluginManager().unregisterListeners(this.getPlugin());
    ...
    public static RyMessageUtil getUtil() {
        if (instance == null) throw new UninitializedUtilException("RyMessageUtil#getUtil", "#getUtil", "Bungeecord");
