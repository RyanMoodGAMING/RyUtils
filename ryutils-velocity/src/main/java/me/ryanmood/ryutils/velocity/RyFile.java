...
public abstract class RyFile implements RyFileBase<Section> {
    ...
    public RyFile(Object plugin, ProxyServer server, @DataDirectory Path dataDirectory, String name) {
        this(plugin, server, dataDirectory, name, false, null, true);
    }

    public RyFile(Object plugin, ProxyServer server, @DataDirectory Path dataDirectory, String name, boolean autoUpdate) {
        this(plugin, server, dataDirectory, name, autoUpdate, "config-version", true);
    }

    public RyFile(Object plugin, ProxyServer server, @DataDirectory Path dataDirectory, String name, boolean autoUpdate, String versionPath) {
        this(plugin, server,dataDirectory, name, autoUpdate, versionPath, true);
    }
    ...
    public RyFile(Object plugin, ProxyServer server, @DataDirectory Path dataDirectory, String name, GeneralSettings generalSettings,
