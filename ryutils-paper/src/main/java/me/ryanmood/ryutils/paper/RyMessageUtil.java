...
public class RyMessageUtil implements RyMessagesBase<Player, CommandSender> {
    ...
    public String translate(Player player, String message) {
        if (Bukkit.getPluginManager().getPlugin("PlaceholderAPI") != null) message = PlaceholderAPI.setPlaceholders(player, message);
    ...
    public void sendConsole(boolean prefix, String message) {
        ...
        Bukkit.getConsoleSender().sendMessage(this.adventureTranslate(message));
    }
    ...
    public void broadcast(String message) {
        Bukkit.broadcast(this.adventureTranslate(message));
    }
    ...
    public void broadcast(Player player, String message) {
        Bukkit.broadcast(this.adventureTranslate(player, message));
    }
    ...
    public static RyMessageUtil getUtil() {
        if (instance == null) throw new UninitializedUtilException("RyMessageUtil#getUtil", "#getUtil", "Paper");
