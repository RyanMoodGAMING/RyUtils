package me.ryanmood.ryutils.spigot.patterns;

import me.ryanmood.ryutils.base.patterns.Pattern;
import me.ryanmood.ryutils.spigot.HexAPI;
...
public class GradientPattern implements Pattern {
    ...
    public String process(String string) {
        ...
        while (matcher.find()) {
            ...
            string = string.replace(matcher.group(), HexAPI.color(content, new Color(Integer.parseInt(start, 16)), new Color(Integer.parseInt(end, 16))));
        }
        return string;
    }
